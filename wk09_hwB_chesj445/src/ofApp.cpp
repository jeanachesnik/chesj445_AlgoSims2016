...
void ofApp::draw(){
    ...
    //JEANA's NOTES
    //Ask Regina about the ofTranslate, and BeginShape(). Don't I need to call the BeginShape in the setup in order for this to be drawn?
    
    ofSetColor(255,20,140);
...
//                    float add = 1;
        ...
        ofVertex( (50 ) * cos((i/100.0)*TWO_PI),
                 (80) * sin((i/100.0)*TWO_PI));
