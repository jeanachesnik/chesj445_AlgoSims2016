 ...
 * Adapted during ofDevCon on 2/23/2012
 ...
 //Regina - This code was from the mesh examples in the oF folder. I wanted to see if I could try and change the colors and experimented with the extrusionAmount. Here is my final submission. I used the notes to help me understand the code a little more. - Jeana
 */
    ...
    if (vidGrabber.isFrameNew()){
        ...
        for (int i=0; i<vidGrabber.getWidth()*vidGrabber.getHeight(); i++){
            ...
            ofFloatColor sampleColor(vidGrabber.getPixels()[i*3]/255.f,				// r
                                     vidGrabber.getPixels()[i*4+1]/255.f,			// g
                                     vidGrabber.getPixels()[i*5+2]/255.f);			// b
