...
//JEANA's NOTES
//I experimented with this example from the examples folder of the oF code, but it kept failing. I'm going to try and use one of the examples from class instead. - Jeana 
...
void ofApp::draw(){
    ...
    // center screen.
    float cx = ofGetWidth() / 2.00;
    float cy = ofGetHeight() / 2.00;
    ...
    shader.setUniform1f("mouseRange", 80);
    ...
    ofFloatColor colorLeft = ofColor::limeGreen;
