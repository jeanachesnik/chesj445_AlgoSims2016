...
//Adding on to this project to add repulsion and spinning force
...
public:
    ...
    //Part 3 additions to add force,spinning, and friction
    float force;
    float spinning;
    float friction;
...
public:
    ...
    //Part 3 - creating the information for the triangle//
    vector <ofPoint> vertices;
    vector <ofColor> colors;
    
    int nTri; //this is going to help with drawing the number of triangles, come back here to experiment with other shapes possibly, or just remember that this is a name only, bbut it's an integer so it must be related to a number figure only
    
    int nVert; // this is referencing the name for how many points will be created on the traingle.
